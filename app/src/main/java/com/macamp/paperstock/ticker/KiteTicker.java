...
import com.macamp.paperstock.kiteconnect.Routes;
...
import com.macamp.paperstock.ticker.OnConnect;
import com.macamp.paperstock.ticker.OnDisconnect;
import com.macamp.paperstock.ticker.OnError;
import com.macamp.paperstock.ticker.OnOrderUpdate;
import com.macamp.paperstock.ticker.OnTicks;
...
/**
 * Ticker provider sends tokens to com.macamp.paperstock.com.macamp.paperstock.ticker server and get ticks from com.macamp.paperstock.com.macamp.paperstock.ticker server. Ticker server sends data in bytes. This Class
 * gets ticks and converts into readable format which includes our own business logic.
 */
public class KiteTicker {

    private String wsuri ;
    private com.macamp.paperstock.ticker.OnTicks onTickerArrivalListener;
    private com.macamp.paperstock.ticker.OnConnect onConnectedListener;
    private OnDisconnect onDisconnectedListener;
    private com.macamp.paperstock.ticker.OnError onErrorListener;
    ...
    /** Set tryReconnection, to instruct KiteTicker that it has to reconnect, if com.macamp.paperstock.ticker is disconnected.
   ...
   public void setOnErrorListener(OnError listener){
     ...
     * @param maxRetries denotes maximum number of retries that the com.macamp.paperstock.ticker can perform.
    ...
    public void setOnConnectedListener(com.macamp.paperstock.ticker.OnConnect listener){
    ...
    /** Disconnects and reconnects com.macamp.paperstock.ticker. */
    private void reconnect(final ArrayList<Long> tokens) {
        ...
        ws.addListener(getWebsocketAdapter());
        connect();
        final com.macamp.paperstock.ticker.OnConnect onUsersConnectedListener = this.onConnectedListener;
