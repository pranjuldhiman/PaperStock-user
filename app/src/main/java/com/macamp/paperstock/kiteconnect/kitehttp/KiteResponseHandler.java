...
import com.macamp.paperstock.kiteconnect.KiteConnect;
import com.macamp.paperstock.kiteconnect.kitehttp.exceptions.*;
...
public class KiteResponseHandler {
    ...
    public KiteException dealWithException(JSONObject jsonObject, int code) throws JSONException {
